...
public class Main {
    ...
    public static void makeRecord() throws Exception{
        ...
        if (array.length != 6){
            throw new Exception("Your length input not supported");
        }
        ...
        try {
            ...
            throw new ParseException("Incorrect birth date format", e.getErrorOffset());
        }
        ...
        try {
            ...
            throw new NumberFormatException("Incorrect phone number format");
        }

        String sex = array[5];
        if (!sex.toLowerCase().equals("m") && !sex.toLowerCase().equals("f")){
            throw new RuntimeException("Incorrect gender format");
        }
